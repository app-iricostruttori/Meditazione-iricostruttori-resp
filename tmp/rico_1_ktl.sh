...
do
   ...
   do
      ...
      then
            ...
            # start versione x java
            # echo "else if (strDateDay.equals(\"${giorno_mese}\"))"
            # echo "     strText = getResources().getStringArray(R.array.giorno_${giorno_mese});"
            # end versione x java
            
            # if (strDateDay == "0101") strText = resources.getStringArray(R.array.giorno_0101)
            # else if (strDateDay == "0201") strText = resources.getStringArray(R.array.giorno_0201)
        
            # start versione x kotlin
            # echo "else if (strDateDay.equals(\"${giorno_mese}\")) strText = getResources().getStringArray(R.array.giorno_${giorno_mese});"
            echo "else if (strDateDay == \"${giorno_mese}\" ) strText = resources.getStringArray(R.array.giorno_${giorno_mese}) "
            # end versione x kotlin
            # la differenza è solo nel break
            break;
      else
            # start versione x java
            # echo "else if (strDateDay.equals(\"${giorno_mese}\"))"
            ...
            # start versione x kotline
            # echo "else if (strDateDay.equals(\"${giorno_mese}\")) strText = getResources().getStringArray(R.array.giorno_${giorno_mese});"
            echo "else if (strDateDay == \"${giorno_mese}\" ) strText = resources.getStringArray(R.array.giorno_${giorno_mese}) "
            # end versione x kotline
